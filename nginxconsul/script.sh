...
CURL='/usr/bin/curl'
OPTIONS='-s'
CONSUL_SERVICES_API="http://172.17.0.1:8500/v1/catalog/services"
CONSUL_SERVICE_API="http://172.17.0.1:8500/v1/catalog/service"
STATUS_UPSTREAMS_API="http://172.17.0.1:8080/status/upstreams"
UPSTREAM_CONF_API="http://172.17.0.1/upstream_conf?"
