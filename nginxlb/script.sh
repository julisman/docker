...
CURL='/usr/bin/curl'
OPTIONS='-s'
CONSUL_SERVICES_API="http://localhost:8500/v1/catalog/services"
CONSUL_SERVICE_API="http://localhost:8500/v1/catalog/service"
STATUS_UPSTREAMS_API="http://localhost:8080/status/upstreams"
UPSTREAM_CONF_API="http://localhost/upstream_conf?"
